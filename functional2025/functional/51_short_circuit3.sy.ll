...
define i32 @_user_set_a(i32 %.4){
.3:
  store i32 %.4, i32* @.G.a
  %.9 = load i32, i32* @.G.a
  ret i32 %.9 
}
define i32 @_user_set_b(i32 %.12){
.11:
  store i32 %.12, i32* @.G.b
  %.17 = load i32, i32* @.G.b
  ret i32 %.17 
}
define i32 @_user_set_d(i32 %.20){
.19:
  store i32 %.20, i32* @.G.d
  %.25 = load i32, i32* @.G.d
  ret i32 %.25 
}
define i32 @main(){
.27:
  store i32 2, i32* @.G.a
  store i32 3, i32* @.G.b
  %.35at0 = call i32 @_user_set_a(i32 0)
  %.36 = icmp ne i32 %.35at0, 0
...
.33:
  ...
  store i32 2, i32* @.G.a
  store i32 3, i32* @.G.b
  %.57at6 = call i32 @_user_set_a(i32 0)
  %.58 = icmp ne i32 %.57at6, 0
  br i1 %.58, label %.59, label %.56
.37:
  %.40at1 = call i32 @_user_set_b(i32 1)
  %.41 = icmp ne i32 %.40at1, 0
...
.56:
  ...
  store i32 2, i32* @.G.d
  %.77at12 = call i32 @_user_set_d(i32 3)
  %.78 = icmp ne i32 %.77at12, 0
  br i1 %.78, label %.73, label %.74
.59:
  %.61at7 = call i32 @_user_set_b(i32 1)
  %.62 = icmp ne i32 %.61at7, 0
  br i1 %.62, label %.55, label %.56
.73:
  br label %.74 
.74:
  %.81 = load i32, i32* @.G.d
...
.142:
  ...
  br label %.161wc 
.161wc:
  br i1 false, label %.167, label %.163wn
.162wloop.:
  call void @putch(i32 32)
  br label %.161wc 
.163wn:
...
.167:
  br i1 true, label %.162wloop., label %.163wn
.174:
  call void @putch(i32 67)
  br label %.175 
.175:
...
.185:
  ...
  br label %.186 
.186:
  br i1 true, label %.204, label %.200
.187:
  br i1 false, label %.185, label %.186
.199:
  call void @putch(i32 73)
  br label %.200 
.200:
  br i1 true, label %.221, label %.215
.204:
  br i1 true, label %.199, label %.200
.213:
...
.235:
  ...
  ret i32 0 
.236:
  br i1 false, label %.246, label %.235
.246:
  br i1 true, label %.234, label %.235
}
