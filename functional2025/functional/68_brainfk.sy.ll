...
attributes #7 = { cold }
@.G.TAPE_LEN = global i32 zeroinitializer
@.G.BUFFER_LEN = global i32 zeroinitializer
@.G.tape = global [65536 x i32] zeroinitializer
@.G.program = global [32768 x i32] zeroinitializer
...
.82:
  ...
  %.89 = getelementptr inbounds [65536 x i32], [65536 x i32]* @.G.tape, i32 0, i32 %.88
  %.90 = load i32, i32* %.89
  %.91 = add i32 %.90, 1
  %.92 = load i32, i32* @.G.ptr11
  %.93 = getelementptr inbounds [65536 x i32], [65536 x i32]* @.G.tape, i32 0, i32 %.92
  store i32 %.91, i32* %.93
  br label %.95 
.83:
  %.99 = load i32, i32* %.41
...
.97:
  ...
  %.104 = getelementptr inbounds [65536 x i32], [65536 x i32]* @.G.tape, i32 0, i32 %.103
  %.105 = load i32, i32* %.104
  %.106 = sub i32 %.105, 1
  %.107 = load i32, i32* @.G.ptr11
  %.108 = getelementptr inbounds [65536 x i32], [65536 x i32]* @.G.tape, i32 0, i32 %.107
...
.112:
  ...
  %.119 = getelementptr inbounds [65536 x i32], [65536 x i32]* @.G.tape, i32 0, i32 %.118
...
.125:
  ...
  %.132 = load i32, i32* @.G.ptr11
  %.133 = getelementptr inbounds [65536 x i32], [65536 x i32]* @.G.tape, i32 0, i32 %.132
...
.142:
  ...
  %.145 = getelementptr inbounds [65536 x i32], [65536 x i32]* @.G.tape, i32 0, i32 %.144
...
define i32 @main(){
.199:
  call void @_user_read_program()
  %.201 = getelementptr inbounds [32768 x i32], [32768 x i32]* @.G.program, i32 0, i32 0
  call void @_user_interpret(i32* %.201)
  ret i32 0 
}
