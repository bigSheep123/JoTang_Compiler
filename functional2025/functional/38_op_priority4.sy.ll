...
define i32 @main(){
.5:
  %.7at0 = call i32 @getint()
  store i32 %.7at0, i32* @.G.a
  %.9at1 = call i32 @getint()
  store i32 %.9at1, i32* @.G.b
  %.11at2 = call i32 @getint()
  store i32 %.11at2, i32* @.G.c
  %.13at3 = call i32 @getint()
  store i32 %.13at3, i32* @.G.d
  %.15at4 = call i32 @getint()
  store i32 %.15at4, i32* @.G.e
  %.23 = load i32, i32* @.G.a
  %.24 = load i32, i32* @.G.b
  %.25 = load i32, i32* @.G.c
  %.26 = mul i32 %.24, %.25
  ...
  br i1 %.33, label %.20, label %.22
.20:
  br label %.21 
.21:
  %.61 = phi i32 [0, %.35], [1, %.20]
  ret i32 %.61 
.22:
  %.36 = load i32, i32* @.G.a
  %.37 = load i32, i32* @.G.b
