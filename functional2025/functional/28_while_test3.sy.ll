...
attributes #7 = { cold }
@.G.g = global i32 zeroinitializer
@.G.h = global i32 zeroinitializer
@.G.f = global i32 zeroinitializer
...
.61wloop.:
  %.67 = load i32, i32* @.G.e
  %.68 = sub i32 %.67, 1
  store i32 %.68, i32* @.G.e
  br label %.70wc 
.62wn:
  %.115 = load i32, i32* @.G.e
  %.116 = add i32 %.115, 1
  store i32 %.116, i32* @.G.e
  br label %.50wc 
.70wc:
  %.74 = load i32, i32* @.G.f
...
.71wloop.:
  %.78 = load i32, i32* @.G.f
  %.79 = sub i32 %.78, 2
  store i32 %.79, i32* @.G.f
  br label %.81wc 
.72wn:
  %.111 = load i32, i32* @.G.f
  %.112 = add i32 %.111, 1
  store i32 %.112, i32* @.G.f
  br label %.60wc 
.81wc:
  %.85 = load i32, i32* @.G.g
  %.86 = icmp slt i32 %.85, 3
  br i1 %.86, label %.82wloop., label %.83wn
.82wloop.:
  %.88 = load i32, i32* @.G.g
  %.89 = add i32 %.88, 10
  store i32 %.89, i32* @.G.g
  br label %.91wc 
.83wn:
  %.107 = load i32, i32* @.G.g
  %.108 = sub i32 %.107, 8
  store i32 %.108, i32* @.G.g
  br label %.70wc 
.91wc:
  %.95 = load i32, i32* @.G.h
  %.96 = icmp slt i32 %.95, 10
  br i1 %.96, label %.92wloop., label %.93wn
.92wloop.:
  %.98 = load i32, i32* @.G.h
  %.100 = add i32 %.98, 8
  store i32 %.100, i32* @.G.h
  br label %.91wc 
.93wn:
  %.103 = load i32, i32* @.G.h
  %.104 = sub i32 %.103, 1
  store i32 %.104, i32* @.G.h
  br label %.81wc 
}
define i32 @main(){
.147:
  ...
  store i32 4, i32* @.G.e
  store i32 6, i32* @.G.f
  %.153at0 = call i32 @_user_EightWhile()
  ret i32 %.153at0 
}
