...
.27:
  ...
  br label %.28 
.28:
  %.54at7 = call i32 @_user_inc_a()
  %.56 = icmp slt i32 %.54at7, 14
  br i1 %.56, label %.51, label %.53
.31:
  %.33at1 = call i32 @_user_inc_a()
  %.34 = icmp ne i32 %.33at1, 0
  br i1 %.34, label %.35, label %.28
.35:
  %.37at2 = call i32 @_user_inc_a()
  %.38 = icmp ne i32 %.37at2, 0
...
.51:
  ...
  %.71 = load i32, i32* @.G.b
  %.73 = mul i32 %.71, 2
  store i32 %.73, i32* @.G.b
  br label %.75 
.52:
  %.77at13 = call i32 @_user_inc_a()
  br label %.75 
.53:
  %.58at8 = call i32 @_user_inc_a()
  %.59 = icmp ne i32 %.58at8, 0
  br i1 %.59, label %.60, label %.52
.60:
  %.62at9 = call i32 @_user_inc_a()
  %.63at10 = call i32 @_user_inc_a()
  %.64 = sub i32 %.62at9, %.63at10
  %.65 = add i32 %.64, 1
  %.66 = icmp ne i32 %.65, 0
