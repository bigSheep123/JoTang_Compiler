...
.92wloop.:
  ...
  %.100 = load i32, i32* %.74
  %.101 = load i32, i32* %.75
  %.102 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* @.G.a, i32 0, i32 %.100, i32 %.101
  store i32 %.99at2, i32* %.102
  %.104 = load i32, i32* %.75
  %.105 = add i32 %.104, 1
  store i32 %.105, i32* %.75
  br label %.91wc 
.93wn:
  %.108 = load i32, i32* %.74
  %.109 = add i32 %.108, 1
  store i32 %.109, i32* %.74
  br label %.82wc 
.117wc:
  %.121 = load i32, i32* %.74
...
.127wloop.:
  ...
  %.135 = load i32, i32* %.74
  %.136 = load i32, i32* %.75
  %.137 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* @.G.b, i32 0, i32 %.135, i32 %.136
  store i32 %.134at5, i32* %.137
  %.139 = load i32, i32* %.75
  %.140 = add i32 %.139, 1
  store i32 %.140, i32* %.75
  br label %.126wc 
.128wn:
  %.143 = load i32, i32* %.74
  %.144 = add i32 %.143, 1
...
.159wloop.:
  %.166 = load i32, i32* %.74
  %.167 = load i32, i32* %.75
  %.168 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* @.G.res, i32 0, i32 %.166, i32 %.167
  %.169 = load i32, i32* %.168
  call void @putint(i32 %.169)
  call void @putch(i32 32)
  %.175 = load i32, i32* %.75
  %.176 = add i32 %.175, 1
  store i32 %.176, i32* %.75
  br label %.158wc 
.160wn:
  call void @putch(i32 10)
  %.181 = load i32, i32* %.74
  %.182 = add i32 %.181, 1
  store i32 %.182, i32* %.74
  br label %.149wc 
}
